...
const Cooky = {
    ...
    addService: (service) => {
        ...
        if (typeof service.id !== 'string') return;
        if (typeof service.exec !== 'function') return;
        if (typeof service.changeStatus !== 'function') return;

        Core.serviceStore[service.id] = service;
    },
