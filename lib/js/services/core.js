	...
	getTranslations() {
		return {
			fr: {
				...
				"core.cooky": "Ce cookie sert à stocker votre sélection des services optionnels."
			},
			en: {
				"core.details": "These are technical cookies, the use of which is specific to JiZy Platform.",
				"core.cooky": "This cookie is used to store your selection of the optional services."
			},
			it: {
			...
			es: {
				...
				"core.cooky": "Esta cookie se utiliza para almacenar su selección de los servicios opcional."
			}
		}
	}
};
