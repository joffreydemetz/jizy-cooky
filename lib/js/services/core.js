...
export default class CoreService extends Service {
	...
	getTranslations() {
		return {
			fr: {
				"core.details": "Il s'agit de cookies techniques dont l'usage est propre à JiZy Cooky.",
				"core.cooky": "Ce cookie sert à stocker votre sélection des services ci-dessous."
			},
			en: {
				"core.details": "These are technical cookies, the use of which is specific to JiZy Cooky.",
				"core.cooky": "This cookie is used to store your selection of the services below."
			},
			it: {
				"core.details": "Si tratta di cookie tecnici, il cui utilizzo è specifico per JiZy Cooky.",
				"core.cooky": "Questo cookie viene utilizzato per memorizzare la selezione dei servizi di seguito."
			},
			es: {
				"core.details": "Son cookies técnicas cuyo uso es específico de JiZy Cooky.",
