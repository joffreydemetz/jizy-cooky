    ...
    _loadMatomo() {
        if (!this.matomoLoaded) {
            ...
            /* this.html(function($el, service){
                ...
                var url = 'https://'+Config.get('service.matomo.host')+'/index.php?module=CoreAdminHome&action=optOutJS'
                    + '&div='+$el.prop('id')
                    + '&showIntro='+Config.get('showIntro', '0')
                    + '&language='+Config.get('language', 'fr')
                    + '&backgroundColor='+Config.get('user.bgColor', 'ffffff')
                    + '&fontColor='+Config.get('user.fgColor', '000000')
                    + '&fontSize='+Config.get('user.fontSize', '11px')
                    + '&fontFamily='+Config.get('user.fontFamily', 'Montserrat');
                console.log(url);
            ...
            /* this.html(function($el, service){
                // console.log(service);
                var frameUrl = 'https://'+Config.get('service.matomo.cdn')+'/index.php?module=CoreAdminHome&action=optOut'
                    + '&div=matomo-opt-out'
                    + '&showIntro='+Config.get('user.showIntro', '0')
            ...
            /* this.html(function($el, service){
                var url = 'https://'+Config.get('service.matomo.cdn')+'/index.php?module=CoreAdminHome&action=optOutJS'
                    + '&div=matomo-opt-out'
                    + '&showIntro='+Config.get('user.showIntro', '0')
                    + '&language='+Config.get('language')
                    + '&backgroundColor='+Config.get('user.bgColor', 'ffffff')
